...
namespace Service
{
    internal sealed class CompanyService : ICompanyService
    {
        ...
        public async Task<IEnumerable<CompanyDto>> GetAllCompaniesAsync(bool trackChanges)
        {
            ...
            var companiesDto = _mapper.Map<IEnumerable<CompanyDto>>(companies); // we have created Map in the MappingProfile.cs "Like Settings"
        ...
        {
            //var company = await _repository.Company.GetCompanyAsync(id, trackChanges); // extracted to a private method
        ...
        // Private methods for repeated tasks
